...
public class TicTacToeXGameInstance extends GameInstance{
    ...
    public void beginPlay() {
        super.beginPlay();
        AObject tttxPlayerController = new TicTacToeXPlayerController(new Vectors.Vector3D (1000.0,0.0,0.0), owner, worldReference);
        AObject tttxAIController = new TicTacToeXAIController(new Vectors.Vector3D (-1000.0,0.0,0.0), owner, worldReference);
    }
}